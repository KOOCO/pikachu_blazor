   ...
   CreateGroupBuyDto.ShippingMethodList.Contains(nameof(DeliveryMethod.SelfPickup));
    ...
    void BlackCatDeliveryTimeCheckedChange(string method, ChangeEventArgs e)
    {
        ...
        if (value)
        {
            ...
            {
                // Remove "UnableToSpecifyDuringPeakPeriods" if it exists
    ...
    void OnShippingMethodCheckedChange(string method, ChangeEventArgs e)
    {
        ...
        if (value)
        {
            if (method == "DeliveredByStore")
            {
                ...
                CreateGroupBuyDto.ShippingMethodList = CreateGroupBuyDto.ShippingMethodList
    ...
    )
    {
        try
        {
            ...
            PurchaseOverviewCropperModal?.Show();
        }
        catch (Exception ex)
        {
            await HandleErrorAsync(ex);
    ...
    )
    {
        try
        {
            ...
            // Show the cropper modal for cropping
            OrderInstructionCropperModal?.Show();
        }
        catch (Exception ex)
        {
            Console.WriteLine(ex.Message);
