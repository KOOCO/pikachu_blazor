...
{
    public partial class ConfirmDialog : ComponentBase, IDisposable
    {
        ...
        [Inject] protected MyBlazoriseUiMessageService? UiMessageService { get; set; }
        [Inject] protected BlazoriseUiMessageService? MessageService { get; set; }
