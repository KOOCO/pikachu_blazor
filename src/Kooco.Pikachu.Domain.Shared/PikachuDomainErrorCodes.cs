...
public static class PikachuDomainErrorCodes
{
    ...
    public const string ItemStyleKeyCannotBeNull = "Pikachu:ItemStyleKeyCannotBeNull";
    public const string ItemStyleKeyCannotBeDuplicate = "Pikachu:ItemStyleKeyCannotBeDuplicate";
    ...
    public const string ItemDescriptionIsRequired = "Pikachu:ItemDescriptionIsRequired";
    ...
    public const string DuplicateCombination = "TenantDeliveryFee:DuplicateCombination";
