...
{
    public class EfCoreAddOnProductRepository(IDbContextProvider<PikachuDbContext> dbContextProvider) : EfCoreRepository<PikachuDbContext, AddOnProduct, Guid>(dbContextProvider), IAddOnProductRepository
    {
